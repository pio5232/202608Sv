...
namespace jh_utility
{
	...
	//{
	//public:
	//	NetMonitor(class jh::SessionManager* sessionMgr) : _sessionMgr(sessionMgr) {}
	...
	//private:		
	//	class jh::SessionManager* const _sessionMgr;
	...
	//{
	//public:
	//	ChatMonitor(class jh::RoomManager* roomMgr, class jh::UserManager* userMgr) : _roomMgr(roomMgr), _userMgr(userMgr) {}
	//	virtual void MonitoringJob() override;
	//private:
	//	class jh::RoomManager* _roomMgr;
	//	class jh::UserManager* _userMgr;
	//};
