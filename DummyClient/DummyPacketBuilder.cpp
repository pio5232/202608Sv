...
PacketBufferRef jh::DummyPacketBuilder::BuildLoginRequestPacket()
{
    jh::LogInRequestPacket logInReqPkt;
    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(logInReqPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildHeartbeatPacket(ULONGLONG timeStamp)
{
    jh::HeartbeatPacket hbPkt;

    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(hbPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildMakeRoomRequestPacket()
{
    jh::MakeRoomRequestPacket makeRoomRequestPkt;
    ...
    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(makeRoomRequestPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildEnterRoomRequestPacket(USHORT roomNum, const WCHAR* roomName)
{
    jh::EnterRoomRequestPacket enterRoomRequestPkt;

    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(enterRoomRequestPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildLeaveRoomRequestPacket(USHORT roomNum, const WCHAR* roomName)
{
    jh::LeaveRoomRequestPacket leaveRoomRequestPkt;

    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(leaveRoomRequestPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildChatRequestPacket(USHORT roomNum)
{
    ...
    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(jh::PacketHeader) + pktSize);

    *buffer << pktSize << static_cast<USHORT>(jh::CHAT_TO_ROOM_REQUEST_PACKET) << roomNum << msgLen;
...
PacketBufferRef jh::DummyPacketBuilder::BuildRoomListRequestPacket()
{
    jh::RoomListRequestPacket roomListRequestPkt;

    PacketBufferRef buffer = jh::MakeShared<PacketBuffer>(sizeof(roomListRequestPkt));
...
PacketBufferRef jh::DummyPacketBuilder::BuildEchoPacket()
{
