...
//
//jh::EchoSystem::EchoSystem(jh::IocpServer* owner) : m_pOwner(owner), m_hLogicThread(nullptr), m_bRunningFlag(true), m_netJobQueue{}, m_sessionConnEventQueue{}
//{
//	if (nullptr == m_pOwner)
//	{
...
//}
//
//jh::EchoSystem::~EchoSystem()
//{
//}
//
//void jh::EchoSystem::Init()
//{
...
//}
//
//unsigned WINAPI jh::EchoSystem::LogicFunc(LPVOID lparam)
//{
...
//}
//
//void jh::EchoSystem::ProcessNetJob()
//{
...
//
//		ProcessPacket(job->m_llSessionId, job->m_wPktType, job->m_pPacket);
//		
//		echoJobQ.pop();
//	}
//}
//
//void jh::EchoSystem::ProcessSystemJob()
//{
...
//}
//
//void jh::EchoSystem::ProcessEchoPacket(LONGLONG sessionId, PacketBufferRef& packet)
//{
//	short len;
//	ULONGLONG data;
//
//	*packet >> data;
//
//	PacketBufferRef pPacket = jh::PacketBuilder::BuildEchoPacket(8, data);
//
