...
namespace jh
{
	...
	{
	public:
		static PacketBufferRef BuildErrorPacket(jh::PacketErrorCode errorCode);

		static PacketBufferRef BuildLogInResponsePacket(ULONGLONG userId);
		static PacketBufferRef BuildMakeRoomResponsePacket(const RoomInfo& roomInfo);
		...
		static PacketBufferRef BuildRoomListResponsePacket(std::vector<jh::RoomInfo>& roomInfos);
		...
		static PacketBufferRef BuildChatNotifyPacket(ULONGLONG senderId, USHORT messageLen, const char* msg);
