...
namespace jh
{
	...
	public:
		...
		virtual void OnStayState(jh::Player* player, float delta) override;
	...
	public:
		...
		virtual void OnEnterState(jh::Player* player) override;
		virtual void OnStayState(jh::Player* player, float delta) override;
		virtual void OnExitState(jh::Player* player) override;
